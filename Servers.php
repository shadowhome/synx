	...
	<div class="row" style="text-align: center;">
		<div class="col-md-2" style="margin-bottom: 20px;">
			<form action="packs.php" method='get'>
				...
				<input type="submit" class="btn btn-lg btn-primary" name="Check" value="Check for updates">
			</form>
		</div>
		<div class="col-md-2" style="margin-bottom: 20px;">
			<form action="Servers.php" method='get'>
				...
				<input type="submit" class="btn btn-lg btn-success" name="Check" value="Show updates only">
			</form>
		</div>
		<div class="col-md-2" style="margin-bottom: 20px;">
			<form action="Servers.php" method='get'>
				<input type="hidden" name=id value="<?php echo $id?>">
				<input type="submit" class="btn btn-lg btn-info" name="Check" value="Show All">
			</form>
		</div>
		<div class="col-md-2" style="margin-bottom: 20px;">
			<form action="Servers.php" method='get'>
				...
				<input type="submit" class="btn btn-lg btn-warning" name="Check" value="Show Security updates only">
			</form>
		</div>
		<div class="col-md-2" style="margin-bottom: 20px;">
			<form action="Upgrades.php" method='get'>
				...
				<input type="hidden" name=servername value="<?php echo $servername?>">
				<input type="hidden" name=ip value="<?php echo $ip?>">
				<input type="submit" class="btn btn-lg btn-default" name="Up" value="Upgrades">
			</form>
		</div>
	</div>
